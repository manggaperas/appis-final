   ...
   <form action="{{ route('user.store') }}" method="POST">
      ...
      <div class="p-5 bg-white">
         ...
         <div class="md:flex md:items-center">
            ...
            <div class="md:w-2/3">
               <div class="flex items-center border-b border-teal-500 py-2">
                  <input class="appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="text" aria-label="Full name" name="name">
               </div>
            </div>
         </div>
         ...
         <div class="md:flex md:items-center">
            ...
            <div class="md:w-2/3">
               <div class="flex items-center border-b border-teal-500 py-2">
                  <input class="appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="text" aria-label="Full name" name="email">
               </div>
            </div>
         </div>
