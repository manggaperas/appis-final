<x-app-layout>
    ...
    {{-- Start Section Form --}}
    <form role="form" action="{{ route('container.update', ['id' => $container->id]) }}" method="POST">
        @csrf
        ...
        <div class="md:flex md:items-center">
            ...
            <div class="md:w-2/3">
                <div class="flex items-center border-b border-teal-500 py-2">
                    <input class="appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="text" aria-label="Full name" name="jenis_container" value="{{ $container->jenis_container }}">
                </div>
            </div>
        </div>
        ...
        <div class="md:flex md:items-center">
            ...
            <div class="md:w-2/3">
                <div class="flex items-center border-b border-teal-500 py-2">
                    <input class="appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="text" aria-label="Full name" name="daya_tampung" value="{{ $container->daya_tampung }}">
                </div>
            </div>
        </div>
        ...
        <div class="md:flex md:items-center">
            ...
            <div class="md:w-2/3">
                <div class="flex items-center border-b border-teal-500 py-2">
                    <input class="appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="text" aria-label="Full name" name="kebutuhan_container" value="{{ $container->kebutuhan_container }}">
                </div>
            </div>
        </div>
        ...
        <div class="md:flex md:items-center">
            ...
            <div class="md:w-2/3">
                <div class="flex items-center border-b border-teal-500 py-2">
                    <input class="appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="text" aria-label="Full name" name="sampah" value="{{ $container->sampah }}">
                </div>
            </div>
        </div>
