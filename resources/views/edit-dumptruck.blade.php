<x-app-layout>
    ...
    {{-- <x-select></x-select> --}}
    <form action="{{ route('dumptruck.update', ['id' => $dumptruck->id]) }}" method="post">
        @csrf
                ...
                <div class="md:w-2/3">
                    <div class="flex items-center border-b border-teal-500 py-2">
                        <select name="volume" class="block appearance-none w-50 bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline mr-3">
                            <option @if($dumptruck->volume == 6 ) selected @endif value="6">6</option>
                            <option @if($dumptruck->volume == 8 ) selected @endif value="8">8</option>
                        </select>
                    </div>
                </div>
            </div>
            <div class="md:flex md:items-center">
                ...
                <div class="md:w-2/3">
                    <div class="flex items-center border-b border-teal-500 py-2">
                        ...
                        type="text" aria-label="Full name" name="jarak" value="{{ $dumptruck->jarak ?? ''}}">
                    </div>
                </div>
            </div>
            <div class="md:flex md:items-center">
                ...
                <div class="md:w-2/3">
                    <div class="flex items-center border-b border-teal-500 py-2">
                        <input class="appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" 
                        type="text" aria-label="Full name" name="kecepatan" value="{{ $dumptruck->kecepatan ?? ''}}">
                    </div>
                </div>
            </div>
            <div class="md:flex md:items-center">
                ...
                <div class="md:w-2/3">
                    <div class="flex items-center border-b border-teal-500 py-2">
                        <input class="appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" 
                        type="text" aria-label="Full name" name="waktu_tunggu" value="{{ $dumptruck->waktu_tunggu ?? ''}}">
                    </div>
                </div>
            </div>
            <div class="md:flex md:items-center">
                ...
                <div class="md:w-2/3">
                    <div class="flex items-center border-b border-teal-500 py-2">
                        <input class="appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                        type="text" aria-label="Full name" name="waktu_bongkar" value="{{ $dumptruck->waktu_bongkar ?? ''}}">
                    </div>
                </div>
            </div>
            <div class="md:flex md:items-center">
                ...
                <div class="md:w-2/3">
                    <div class="flex items-center border-b border-teal-500 py-2">
                        <input class="appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                        type="text" aria-label="Full name" name="waktu_istirahat" value="{{ $dumptruck->waktu_istirahat ?? ''}}">
                    </div>
                </div>
            </div>
            <div class="md:flex md:items-center">
                ...
                <div class="md:w-2/3">
                    <div class="flex items-center border-b border-teal-500 py-2">
                        <input class="appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                        type="text" aria-label="Full name" name="waktu_shift" value="{{ $dumptruck->waktu_shift ?? ''}}">
                    </div>
                </div>
            </div>
            <div class="md:flex md:items-center">
                ...
                <div class="md:w-2/3">
                    <div class="flex items-center border-b border-teal-500 py-2">
                        <input class="appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                        type="text" aria-label="Full name" name="sampah" value="{{ $dumptruck->sampah ?? ''}}">
                    </div>
                </div>
            </div>
