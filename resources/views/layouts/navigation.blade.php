            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('welcome') }}">
                        <img src="{{ asset('/img') }}/dlh.png" width="100" height="100">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-dropdown align="right" width="48" :style="'margin-top: 200px;'" :class="'inline-flex items-center'">
                        <x-slot name="trigger">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route(strtolower($cat))">
                                {{ __($cat) }}
                            </x-dropdown-link>
                            @endforeach
                        </x-slot>
